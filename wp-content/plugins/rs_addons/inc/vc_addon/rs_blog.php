		...
		while($best_wp->have_posts()): $best_wp->the_post();
				...
				if( $blog_date == 'yes'){
					$show_date = '<div class="blog-date">
							...
							$full_date_show = '<div class="full_date"> <i class="fa fa-clock-o" aria-hidden="true"></i>
								'.$full_date.' <span><i class="fa fa-comment-o" aria-hidden="true"></i> '.$comments_count.'</span>
							</div>';
				}
				...
				if('style4'==$news_style){
					$html .='
						<div class="blog-item style4 '.$no_thumb.'">
							<div class="blog-img content-overlay"> 
								'.$post_img_url.'
								'.$full_date_show.'
								<div class="blog-meta">
