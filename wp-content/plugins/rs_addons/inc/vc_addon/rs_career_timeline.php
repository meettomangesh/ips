	        			...
	        			<div class="cd-timeline__container">
							...
							$best_wp = new wp_Query(array(
								...
								while($best_wp->have_posts()): $best_wp->the_post();
									...
									if(!empty($career_id)){
										$career_video = '<iframe src="'.$protocol.'://www.youtube.com/embed/'.$career_id.'" width="100%" height="200" frameborder="0" allowfullscreen></iframe>';
									}
							
			$html .='<div class="cd-timeline__block js-cd-block">
	                     <div class="cd-timeline__img cd-timeline__img--picture js-cd-img etimeimg'.$i.'">
	                     	<span class="timeline-year">'.$join_year.'</span>
	                     </div>
	                     <div class="cd-timeline__content js-cd-content etimeline'.$i.'" >
	                     	<div class="short-info">
	                     		<div class="career_thumb">'.$featured_img.'</div>
