<?php function cl_price_function( $atts, $content ) {
    ...
    extract(
		...
		$btn_code='<a '. $attributes.' class="btn-table btn-1" style="background:'.$atts['button_color'].'; color:'.$atts['button_text_color'].'">'. $atts['button_text'].'</a> ';
			...
			$btn_code= '<a '. $attributes.' class="btn-table btn-1" style="background:'.$atts['button_color'].'; border-color: '.$atts['button_border_color'].';  color:'.$atts['button_text_color'].'">'. $atts['button_text'].'</a>';
		...
		$subtitle_color_show = ($atts['subtitle_color']) ? 'style="color:'.$atts['subtitle_color'].'"' : '';	
				...
				<div class="top">
				 '.$featured.'
				  ...
				  <div class="cl-subheader">
					<h3 style="color:'.$atts['price_color'].'"> <span class="dolar"  style="color:'.$atts['subtitle_color'].'">'.$atts['currency'].'</span>'. $atts['price'].'					  
					</h3>
				    <h5 '.$subtitle_color_show.'> '.$atts['per'].'</h5>
					 <h6 '.$subtitle_color_show.'>'. $atts['subtitle'].'</h6>
				  </div>
				</div>
